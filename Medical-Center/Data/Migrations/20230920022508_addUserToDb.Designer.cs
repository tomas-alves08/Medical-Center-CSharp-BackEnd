...
namespace Medical_Center.Migrations
{
    ...
    [Migration("20230920022508_addUserToDb")]
            ...
            modelBuilder.Entity("Medical_Center.Data.Models.Appointment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateTime = new DateTime(2023, 9, 20, 14, 25, 8, 242, DateTimeKind.Local).AddTicks(2721),
                            DiagnosisDetails = "",
                            DoctorId = 1,
                            PatientId = 1,
                            UpdateTime = new DateTime(2023, 9, 20, 14, 25, 8, 242, DateTimeKind.Local).AddTicks(2762)
                        });
                });
            ...
            modelBuilder.Entity("Medical_Center.Data.Models.Doctor", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            City = "Wellington",
                            CreateTime = new DateTime(2023, 9, 20, 14, 25, 8, 242, DateTimeKind.Local).AddTicks(2885),
                            ExtraDetails = "",
                            FirstName = "Joseph",
                            LastName = "Smith",
                            RegistrationNumber = 167948,
                            UpdateTime = new DateTime(2023, 9, 20, 14, 25, 8, 242, DateTimeKind.Local).AddTicks(2886)
                        });
                });
            ...
            modelBuilder.Entity("Medical_Center.Data.Models.Patient", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            City = "Wellington",
                            CreateTime = new DateTime(2023, 9, 20, 14, 25, 8, 242, DateTimeKind.Local).AddTicks(2872),
                            ExtraDetails = "",
                            FirstName = "Tomas",
                            LastName = "Alves de Souza",
                            UpdateTime = new DateTime(2023, 9, 20, 14, 25, 8, 242, DateTimeKind.Local).AddTicks(2874)
                        });
                });
